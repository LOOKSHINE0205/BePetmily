    ...
    <header>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="album_list.html">앨범</a></li>
            </ol>
        </nav>
            ...
            <div class="container">
                ...
                <div class="album-grid" id="album-grid">
                    <div class="album-item">
                        <img src="../img/sample_image.png" alt="앨범 이미지">
                        <h1>강아지 제목</h1>
                        <p>강아지 설명 및 상세 정보</p>
                    </div>
                    <div class="album-item">
                ...
                <div class="pagination-container">
                    ...
                    <div class="sort-container">
                        <select id="sort-dropdown">
                            ...
                            <option value="date">추천순 정렬</option>
                        </select>
                    </div>
                </div> <!-- 추가된 닫는 태그 -->
    ...
    <footer class="footer-wrapper">
        <div class="footer-container">
            <div class="footer-top-bar">
                ...
                <span class="footer-top"><a href="#" id="back-to-top1"><img src="../img/Base_up01.png" alt="맨 위로"></a></span>
            </div>
            <hr> 
