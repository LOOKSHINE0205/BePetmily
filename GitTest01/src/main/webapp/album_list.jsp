...
<body>
	...
	function DataView(var1) {
	    var form = document.getElementById('DataForm');
	    var Myelement = document.getElementById('postId');


	    console.log("va121rkkk1[" + document.getElementById('postId').value + "]");
	    Myelement.setAttribute('value',var1);
	    

	    console.log("varkkk1[" + document.getElementById('postId').value + "]");
	    form.submit();
	}
			...
			<ul>
				...
				<li class="dropdown facilities-tab"><a>시설</a>
					<div class="dropdown-content facilities-content">
						<a href="map.jsp?cate=hos&page=1">병원</a> <a
							href="map.jsp?cate=acco&page=1">숙박</a> <a
							href="map.jsp?cate=cafe&page=1">카페/식당</a> <a
							href="map.jsp?cate=etc&page=1">기타시설</a> <a
							href="map.jsp?cate=all&page=1">주변위치</a>
					</div></li>
		...
		<main>
			<div class="container">
				<div class="write-button-container">
					...
					<form action="PostViewServlet" id="DataForm" method="post">
						<input id="postId" class="postId" name="postId" value="" type=hidden>
					</form>
                ...
                %>
					<div class="album-item">
						...
						<img src="<%= post.getImgFile() %>" alt="앨범 이미지" onclick="DataView(<%= post.getPostId() %>)">
						<% } %>
						<h1><%= post.getTitle() %></h1>
						<p><%= post.getContent() %></p>
					</div>
			...
			<div class="footer-top-bar">
				<span class="footer-lang">🌐 대한민국/한국어 </span> <span
					class="footer-top"><a href="#" id="back-to-top1"><img
						src="assets/img/Base_up01.png" alt="맨 위로"></a></span>
			</div>
			<hr>
