    ...
    <form id="symptom-form">
        <div class="dropdown-container">
            ...
            <select id="symptom-select" name="symptoms" multiple>
                ...
                <option value="Redness around Eye area">눈 주위의 발적</option>
                ...
                <option value="Tender abdomen">부드러운 복부</option>
                ...
                <option value="Wrinkled forehead">주름진 이마</option>
                <option value="Continuously erect and stiff ears">계속 세워지고 뻣뻣한 귀</option>
                <option value="Grinning appearance">웃는 모습</option>
                <option value="Stiff and hard tail">뻣뻣하고 딱딱한 꼬리</option>
                ...
                <option value="Lumps">혹</option>
                <option value="Swelling">부풀음</option>
                ...
                <option value="Weakness">약함</option>
                ...
                <option value="excess jaw tone">과도한 턱 톤</option>
                ...
                <option value="Enlarged Liver">비대해진 간</option>
                <option value="lethargy">무기력</option>
                <option value="Purging">구토</option>
                <option value="Bloody discharge">혈액 분비물</option>
